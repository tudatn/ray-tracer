...
Spheres *intersect_scene(Point, Vector, Spheres *, Point *, Spheres *);
...
// check if all lights are blocked (for shadow rays)
int is_all_light_blocked(Point, Vector, Spheres *, Spheres *);
